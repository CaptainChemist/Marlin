...
#define STRING_VERSION_CONFIG_H "MendelMax_2-0_RAMBo_1-1b on " __DATE__ " " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "Maker's Tool Works" //Who made the changes.
...
#define TEMP_RESIDENCY_TIME 25	// (seconds)
...
#define PIDTEMP
#define BANG_MAX 128 // limits current to nozzle while in bang-bang mode; 256=full current
...
// MTW 24v Heater Cartridge as of 5-2013
	#define  DEFAULT_Kp 18.66
	#define  DEFAULT_Ki 1.73
	#define  DEFAULT_Kd 52.22  
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, argressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 76.59
    #define  DEFAULT_bedKi 3.99
    #define  DEFAULT_bedKd 367.68
...
#define DEFAULT_MAX_FEEDRATE          {500, 500, 7.5, 25}    // (mm/sec)
...
#define MOTOR_CURRENT {135,135,175,135,135} // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
//===========================================================================
//=============================Additional Features===========================
//===========================================================================
